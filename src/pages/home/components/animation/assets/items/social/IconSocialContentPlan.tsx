...
const IconSocialContentPlan: React.FC<IconProps> = ({ thickness = 0, ...props }) => {
  const filterId = `filter-${useId().replace(/:/g, '')}`

  return (
    <svg width="34" height="34" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg" {...props}>
      {thickness > 0 && (
        <defs>
          <filter id={filterId}>
...
export default IconSocialContentPlan
