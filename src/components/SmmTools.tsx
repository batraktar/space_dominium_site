...
import styles from "./smm-tools.module.scss";
      ...
      <div className={styles.tools__container}>
        ...
        >
          <div className={styles.tools__track}>
            {[...tools, ...tools, ...tools].map((tool, index) => ( // Tripled for smoother infinite loop
              <div key={`${tool.id}-${index}`} className={`${styles.card} ${styles[`card--${tool.variant}`]}`}>
        ...
        <div className={styles.tools__footer}>
          <a href="#" className={styles.tools__btn}>
            ...
            <svg width="24" height="12" viewBox="0 0 24 12" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M1 6H23M23 6L18 1M23 6L18 11" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </a>
        </div>
      </div>
